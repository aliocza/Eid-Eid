...
namespace Eid
{
    class EidData
    {
        ...
        private void InitData(String smartCardName, List<String> labels) {
            ...
            if (labels == null) {
                ...
                List<EidAttributes> eidAttributes = Enum.GetValues(typeof(EidAttributes))
                                .Cast<EidAttributes>()
                                .ToList();
                foreach (EidAttributes attrib in eidAttributes)
                {
            ...
            if (selectedSlot != null)
            {
                ...
                foreach (IObjectHandle obj in foundObjects)
                {
                    ...
                    if (plainKeyValue != null && plainKeyValue.Length > 0)
                    {
                        ...
                        try
                        {
                            EidAttributes eidAttributes = (EidAttributes)Enum.Parse(typeof(EidAttributes), label);
    ...
    private String FormatDate(String date) {
        ...
        public void Setvalidity_begin_date(byte[] value)
        {
            if (value != null)
            {
                this.validity_begin_date = FormatDate(System.Text.Encoding.UTF8.GetString(value));
            }
        }
        ...
        public void Setvalidity_end_date(byte[] value)
        {
            if (value != null)
            {
                this.validity_end_date = FormatDate(System.Text.Encoding.UTF8.GetString(value));
            }
        }
        ...
        public void Setdate_of_birth(byte[] value)
        {
            if (value != null)
            {
                this.date_of_birth = FormatBirthdate(System.Text.Encoding.UTF8.GetString(value));
            }
        }
        ...
        public Dictionary<String, String> GetAllValues()
        {
            ...
            foreach (EidAttributes attrib in eidAttributes)
            {
                ...
                try
                {
                    data.Add(attrib.ToString(), (String)this.GetType().GetMethod("Get" + attrib.ToString()).Invoke(this, null));
                }catch (Exception e)
                {
        ...
        public Dictionary<String, String> GetValues(List<String> labels)
        {
            ...
            try
            {
                EidAttributes eidAttributes = (EidAttributes)Enum.Parse(typeof(EidAttributes), labelsJoin);
            }
            catch (Exception e)
            {
                throw e;
